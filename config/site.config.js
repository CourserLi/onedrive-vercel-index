...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '1480589612@qq.com',
  ...
  protectedRoutes: ['/提供下载/HWS-华为松山湖', '/提供下载/KingSoft'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:courserli@foxmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/CourserLi',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/courserli',
    },
  ],
